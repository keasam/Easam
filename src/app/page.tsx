...
export default function Home() {
  ...
  return <MotionConfig reducedMotion="user"><div className="relative flex min-h-screen flex-col overflow-x-clip">
    ...
    <main id="main-content" className="flex-1"><PrintResume /><Hero onOpenChat={openChat} /><JdMatch /><SkillMarquee /><About /><Expertise /><Experience /><Divider /><Projects /><Divider /><Products /><Highlights /><FeaturedVideo /><AiExperience /><Toolkit /><Divider /><Contact /></main>
    <Footer />
